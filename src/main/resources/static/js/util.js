...
let canvas, ctx;
let renderer, stage;
let sw = document.getElementById("logo").clientWidth;
let sh = document.getElementById("logo").clientHeight;
...
function canvasResize() {
    sw = document.getElementById("logo").clientWidth;
    sh = document.getElementById("logo").clientHeight;
